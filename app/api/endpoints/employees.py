...
def search_employees(
    *,
    ...
    organization_id: str = Query("default", description="Organization ID for column configuration"),
    ...
    # Validate columns
    valid_columns = set(["id", "name", "email", "phone", "status", "department", "position", "location", 
